...
$featurearray = array("Elev" => array("Lucas","Mathias","Magnus","Mikkel","Frederik","Oliver","Mads","Emil","Nikolaj","Tobias","Mathilde","Emma","Laura","Sofie","Julie","Ida","Caroline","Freja","Sarah","Anna","Muhammed","Ali","Ahmad","Yusuf","Omar","Mustafa","Malik","Yunus","Anas","Ibrahim","Yasmin","Aya","Anima","Fatima","Aisha","Noor","Salma","Azra","Aida","Fatma"),"Klassetrin" => array("1.g","2.g","3.g"),"Arbejdsindsats" => array("Level 1 effort","Level 2 effort","Level 3 effort"),"Fagligt niveau" => array("Level 1 peformance","Level 2 peformance","Level 3 peformance"));
